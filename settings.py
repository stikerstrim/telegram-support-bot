...
TELEGRAM_TOKEN = os.getenv("6851137208:AAGIitHWVtMremZfDBnOSwKjMQmPHbDg6ms")
if TELEGRAM_TOKEN is None:
    raise Exception("Please setup the .env variable TELEGRAM_TOKEN.")

PORT = int(os.environ.get('PORT', '8443'))
HEROKU_APP_NAME = os.getenv("kaktusdiego")

TELEGRAM_SUPPORT_CHAT_ID = os.getenv("-4095484039")
...
WELCOME_MESSAGE = os.getenv("Ну привет уйгур")
